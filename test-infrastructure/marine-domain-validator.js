...
class MarineDomainValidator {
  ...
  validateAutopilotAccuracy(autopilotData) {
    ...
    // Validate heading command accuracy
    if (autopilotData.commandedHeading !== undefined && autopilotData.actualHeading !== undefined) {
      const headingError = this.calculateHeadingError(autopilotData.actualHeading, autopilotData.commandedHeading);
