...
class NmeaGenerator {
  ...
  generateTimedSensorMessages(timing, now) {
    ...
    if (this.shouldGenerateMessage('tanks', timing, now))
      messages.push(...this.generateTankSensors());
    if (this.shouldGenerateMessage('electrical', timing, now))
      messages.push(...this.generateElectricalSensors());
    if (this.shouldGenerateMessage('engines', timing, now))
      messages.push(...this.generateEngineSensors());
