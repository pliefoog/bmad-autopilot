...
18,0.0,6.0,7.0,6.5,5.5,3.5`;
    ...
    describe('loadPolarDiagram', () => {
        ...
        test('should handle invalid file paths', async () => {
            await expect(processor.loadPolarDiagram('nonexistent.csv'))
                .rejects.toThrow('Failed to read polar file');
    ...
    describe('validation', () => {
        test('should validate polar data structure', async () => {
            ...
            await expect(processor.loadPolarDiagram(emptyFile))
                .rejects.toThrow('Empty polar diagram file');
...
12,5.0,4.0`;
            ...
            expect(consoleSpy).toHaveBeenCalledWith(
                expect.stringContaining('limited angle range')
            );
    ...
    describe('real polar data tests', () => {
        const orcBasedPolarFile = path.resolve(__dirname, '../../../../../../vendor/polar-diagrams/j35-polar.csv');
