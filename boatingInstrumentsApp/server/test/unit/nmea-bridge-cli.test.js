...
describe('NMEA Bridge CLI Interface', () => {
  ...
  describe('Live Mode Arguments', () => {
    ...
    test('should validate port number range', () => {
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Port must be between 1 and 65535'));
    });
  });
  ...
  describe('File Mode Arguments', () => {
    ...
    test('should validate rate parameter', () => {
      process.argv = ['node', 'nmea-bridge.js', '--file', '/path/to/test.nmea', '--rate', 'invalid'];
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Rate must be a valid number'));
    });
  });
  ...
  describe('Scenario Mode Arguments', () => {
    ...
    test('should reject scenario mode without scenario name', () => {
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Scenario name is required'));
    });

    test('should validate speed parameter', () => {
      process.argv = ['node', 'nmea-bridge.js', '--scenario', 'basic-navigation', '--speed', 'invalid'];
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Speed must be a valid number'));
    });
    ...
    test('should validate speed parameter range', () => {
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Speed must be greater than 0'));
    });
  });
  ...
  describe('Global Options', () => {
    ...
    test('should handle conflicting quiet and verbose flags', () => {
      process.argv = ['node', 'nmea-bridge.js', '--scenario', 'basic-navigation', '--quiet', '--verbose'];
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Cannot use both --quiet and --verbose'));
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    test('should handle invalid mode combinations', () => {
      process.argv = ['node', 'nmea-bridge.js', '--live', '192.168.1.10', '10110', '--file', '/path/to/test.nmea'];
      ...
      expect(process.exit).toHaveBeenCalledWith(1);
      expect(console.error).toHaveBeenCalledWith(expect.stringContaining('Cannot specify multiple modes'));
    });
