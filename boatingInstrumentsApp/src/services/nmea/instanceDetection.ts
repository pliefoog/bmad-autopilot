 ...
 * 
 * ⚠️ **DEPRECATED** - This service is obsolete in the registry architecture.
 * Use WidgetRegistrationService instead, which subscribes to sensorRegistry events.
 * 
 * This file is kept for reference but should NOT be used in new code.
 * The code has been updated to use sensorRegistry to prevent crashes,
 * but the entire polling-based approach is superseded by event-driven architecture.
 *
 * @deprecated Use WidgetRegistrationService with sensorRegistry events
 *
 * Old Responsibilities (now handled by WidgetRegistrationService):
