...
export class NotificationManager {
  ...
  private async requestiOSPermissions(): Promise<NotificationPermission> {
    ...
    console.log('[Notifications] iOS: Requesting notification permissions');
  ...
  private async requestAndroidPermissions(): Promise<NotificationPermission> {
    try {
      console.log('[Notifications] Android: Requesting notification permissions');
      ...
      console.log('[Notifications] Android: Requesting battery optimization exemption');
  ...
  private async setupiOS(): Promise<void> {
    console.log('[Notifications] Setting up iOS notifications');
  ...
  private async setupAndroid(): Promise<void> {
    console.log('[Notifications] Setting up Android notifications');
  ...
  private async setupDesktop(): Promise<void> {
    console.log('[Notifications] Setting up desktop notifications');
  ...
  private async createAndroidNotificationChannel(channel: NotificationChannel): Promise<void> {
    ...
    console.log(`[Notifications] Android: Creating channel ${channel.id}`);
  }
  ...
  public async sendAlarmNotification(
    ...
    try {
      ...
      console.log(`[Notifications] Smart processing result: ${smartResult.action} (${smartResult.reasoning})`);
  ...
  private async sendImmediateNotification(
    ...
    console.log(`[Notifications] Immediate notification sent: ${content.title}`);
  }
   ...
   */
  public async scheduleLocalAlarmNotification(alarm: AlarmNotificationData, delaySeconds: number = 0): Promise<void> {
    console.log(`[Notifications] Scheduling local notification for alarm ${alarm.id} in ${delaySeconds}s`);
  ...
  private getChannelIdForAlarmLevel(level: string): string {
    switch (level) {
      case 'critical': return 'critical_alarms';
      case 'warning': return 'warning_alarms';
      case 'info': return 'info_alarms';
  ...
  private async sendiOSNotification(notification: any): Promise<void> {
    ...
    console.log('[Notifications] iOS: Sending notification:', notification.title);
  }
  ...
  private async sendAndroidNotification(notification: any): Promise<void> {
    ...
    console.log('[Notifications] Android: Sending notification:', notification.title);
  }
  ...
  private async sendDesktopNotification(notification: any): Promise<void> {
    ...
    try {
      ...
      console.log('[Notifications] Desktop: Notification sent:', notification.title);
  ...
  public async handleNotificationAction(
    ...
    console.log(`[Notifications] Handling action: ${actionId}`, notificationData);
  ...
  private async acknowledgeAlarm(alarmId: string): Promise<void> {
    ...
    console.log(`[Notifications] Acknowledging alarm: ${alarmId}`);
  }
  ...
  private async snoozeAlarm(alarmId: string, durationMs: number): Promise<void> {
    ...
    console.log(`[Notifications] Snoozing alarm ${alarmId} for ${durationMs}ms`);
  }
  ...
  private async openApp(data: any): Promise<void> {
    ...
    console.log('[Notifications] Opening app from notification', data);
  }
  ...
  private async silenceAlarms(): Promise<void> {
    ...
    console.log('[Notifications] Silencing all alarms');
  }
  ...
  public updateConfig(newConfig: Partial<NotificationConfig>): void {
    ...
    console.log('[Notifications] Configuration updated');
  }
