...
export class PerformanceMonitor {
  ...
  public getMetrics(): PerformanceMetrics {
    ...
    const memoryUsageMB = latestSnapshot ? latestSnapshot.heapUsed / (1024 * 1024) : 0;
  ...
  public getReport(): PerformanceReport {
    ...
    if (metrics.memoryUsageMB > this.MAX_MEMORY_BASELINE_MB) {
      score -=
        ((metrics.memoryUsageMB - this.MAX_MEMORY_BASELINE_MB) / this.MAX_MEMORY_BASELINE_MB) * 30;
    }
