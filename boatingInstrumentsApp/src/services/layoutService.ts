...
export class LayoutService {
  ...
  static getDefaultLayout(): WidgetLayout[] {
    return [
      { id: 'depth', position: { x: 0, y: 0 }, size: { width: 160, height: 160 }, visible: true, order: 0 },
      { id: 'speed', position: { x: 170, y: 0 }, size: { width: 160, height: 160 }, visible: true, order: 1 },
      { id: 'wind', position: { x: 0, y: 170 }, size: { width: 160, height: 160 }, visible: true, order: 2 },
      { id: 'gps', position: { x: 170, y: 170 }, size: { width: 160, height: 160 }, visible: true, order: 3 },
      { id: 'compass', position: { x: 0, y: 340 }, size: { width: 160, height: 160 }, visible: true, order: 4 },
      { id: 'theme', position: { x: 170, y: 340 }, size: { width: 160, height: 160 }, visible: true, order: 5 },
    ];
  }
