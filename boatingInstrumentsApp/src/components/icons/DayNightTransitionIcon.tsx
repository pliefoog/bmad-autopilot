    ...
    <Svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      ...
      <Path
        d={`M ${halfSize + size * 0.25 - moonRadius} ${halfSize - moonRadius}
           A ${moonRadius} ${moonRadius} 0 1 1 ${halfSize + size * 0.25 - moonRadius} ${halfSize + moonRadius}
           A ${moonRadius * 0.6} ${moonRadius * 0.6} 0 1 0 ${halfSize + size * 0.25 - moonRadius} ${halfSize - moonRadius} Z`}
        fill={color}
      />
    </Svg>
  );
