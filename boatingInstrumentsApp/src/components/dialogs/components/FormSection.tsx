    ...
    <View style={styles.skeletonContainer}>
      {[...Array(3)].map((_, index) => (
        <View key={index} style={styles.skeletonRow}>
          <View style={[styles.skeletonBar, styles.skeletonLabel, { backgroundColor: theme.border }]} />
          <View style={[styles.skeletonBar, styles.skeletonInput, { backgroundColor: theme.border }]} />
        </View>
      ))}
    </View>
  ), [styles, theme]);
