...
export const ThresholdEditor: React.FC<ThresholdEditorProps> = React.memo(({
   ...
   */
  const validateAgainstOther = useCallback((newValue: number): boolean => {
  ...
  const handleTextBlur = useCallback(() => {
    ...
    onBlur?.();
  }, [textValue, value, formatSpec.decimals, min, max, onChange, onBlur, validateAgainstOther, triggerShakeAnimation]);
  ...
  return (
    ...
    >
      ...
      <View style={styles.editorRow}>
        ...
        >
          <UniversalIcon name="remove" size={20} color={disabled ? theme.textSecondary : theme.text} />
        </Pressable>
        ...
        >
          <UniversalIcon name="add" size={20} color={disabled ? theme.textSecondary : theme.text} />
        </Pressable>
      </View>
