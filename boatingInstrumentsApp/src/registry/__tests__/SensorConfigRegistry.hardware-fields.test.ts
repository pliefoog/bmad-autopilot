  ...
  describe('Battery sensor', () => {
    ...
    it('should fall back to default when hardware value not available', () => {
      ...
      const chemistryValue =
        batteryInstance[chemistryField!.hardwareField!] ?? chemistryField!.default;
      const capacityValue =
        batteryInstance[capacityField!.hardwareField!] ?? capacityField!.default;
